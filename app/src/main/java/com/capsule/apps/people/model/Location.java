...
public class Location implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (mStreet != null ? !mStreet.equals(location.mStreet) : location.mStreet != null) return false;
        if (mCity != null ? !mCity.equals(location.mCity) : location.mCity != null) return false;
        if (mState != null ? !mState.equals(location.mState) : location.mState != null) return false;
